    ...
    return (
      <section className="bg-white dark:bg-slate-800 rounded-2xl border border-gray-100 dark:border-slate-700 p-4">
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          Demo mode was disabled{org.demoDisabledAt && !isNaN(new Date(org.demoDisabledAt)) ? ` on ${new Date(org.demoDisabledAt).toLocaleDateString()}` : ''}. All demo data has been archived.
        </p>
      </section>
    );
  }
